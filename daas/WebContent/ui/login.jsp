...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<%=basePath %>assets/lib/bootstrap/css/bootstrap.css">
    <link rel="stylesheet" href="<%=basePath %>assets/css/login.css">
    <link rel="stylesheet" href="<%=basePath %>assets/lib/magic/magic.css">
    <script>
...
<div class="container">
    <div class="text-center">
        <img src="<%=basePath %>assets/img/logo.png" alt="Metis Logo">
    </div>
    <div class="tab-content">
        <div id="login" class="tab-pane active">
            <form action="<%=basePath %>login" class="form-signin" method="post">
        ...
        <div id="signup" class="tab-pane">
            <form action="<%=basePath %>register" class="form-signin" method="post">
                <input type="text" placeholder="username" class="form-control" name="username">
    ...
    <div class="text-center">
      ...
      <script src="<%=basePath %>assets/lib/jquery-2.0.3.min.js"></script>
