...
@Configuration
@EnableJpaRepositories(basePackages = "data.as.a.service.access.repo.jpa")
@EnableTransactionManagement
public class MySQLJPAConfig {
	@Bean
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		LocalContainerEntityManagerFactoryBean factory = new LocalContainerEntityManagerFactoryBean();
		factory.setPackagesToScan("data.as.a.service.access.entity.jpa");
		...
		jpaProperties.put("hibernate.connection.url", "jdbc:mysql://localhost:3306/daas");
